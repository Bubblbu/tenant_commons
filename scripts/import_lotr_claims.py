...
sica_core: raw rows into raw_lotr_ownership, then derived common_owner
claims into ownership_claims.

Decoupled from the main sica_core rebuild cadence — like
...
See src/sica_core/ingest/lotr_claims.py for the entity-pair extraction
logic and src/sica_core/schema.sql for why raw_lotr_ownership is PERSISTENT
...
from sica_core.ingest.lotr_claims import derive_lotr_ownership_claims  # noqa: E402
from sica_core.ingest.raw_lotr import ingest_raw_lotr  # noqa: E402
